...
class SFVRConfig : public Mod {
public:
    static std::shared_ptr<SFVRConfig>& get();
...
private:
    ...
    ModToggle::Ptr m_remember_menu_state{ ModToggle::create(generate_name("RememberMenuState"), true) };
